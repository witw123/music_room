    ...
    <section className="mt-7">
      ...
      <div className="mt-5 grid gap-8 border-b border-white/[0.1] pb-9 lg:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <div className="flex min-w-0 flex-col justify-end">
          ...
          <p className="mt-5 max-w-3xl text-sm leading-7 text-white/45">{playlist.description || "暂无歌单简介"}</p>
...
function PlaylistArtwork({ alt, src }: { alt: string; src: string | null }) {
  ...
  return <img alt={alt} className="aspect-square w-full rounded-2xl object-cover" loading="lazy" src={getArtworkSourceUrl(src)} />;
}
