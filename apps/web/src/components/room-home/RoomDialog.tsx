...
export function RoomDialog({
  ...
  return createPortal(
    ...
    >
      <div
        aria-modal="true"
        className="light-dialog-surface hide-scrollbar relative m-auto shrink-0 max-h-[min(calc(90*var(--app-dvh)),calc(100*var(--app-dvh)-env(safe-area-inset-top)-env(safe-area-inset-bottom)-2rem))] w-full max-w-lg overflow-y-auto overscroll-contain rounded-2xl border border-surface-border bg-surface p-5 shadow-2xl sm:p-6"
        role="dialog"
      >
