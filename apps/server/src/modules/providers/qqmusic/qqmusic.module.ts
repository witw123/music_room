...
@Module({ imports: [AuthModule, RoomCoreModule], controllers: [QqMusicController], providers: [QqMusicAccountService, QqMusicApiClient, QqMusicCryptoService, QqMusicService], exports: [QqMusicService] })
