...
export const pieceAvailabilityRequestChannel = "music-room:piece-availability-request";
...
export const assetAvailabilityRequestChannel = "music-room:asset-availability-request-v4";
